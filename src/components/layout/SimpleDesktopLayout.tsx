...
export function SimpleDesktopLayout({
  ...
  const mockClinicalEntries: ClinicalEntry[] =
    selectedPatient?.id === 1
      ? [
          ...
          },
          {
            ...
            content:
              "Continue current antibiotic regimen. Plan for step-down to ward if stable trajectory continues for 24h. Consider respiratory therapy consultation for airway clearance.",
            author: {
          ...
          },
          {
            ...
            content:
              "Met with parents to discuss current status and plan. Explained improvement trajectory and discharge planning timeline. Parents expressed understanding and gratitude.",
            author: {
              name: "Dr. Sarah Chen",
              role: "Attending Physician",
              specialty: "Pediatric Critical Care",
  ...
  return (
    <div className="h-screen flex bg-background">
      ...
      {/* Sidebar */}
      <div
        className={`${sidebarCollapsed ? "w-12" : "w-80"} transition-all duration-200 bg-card border-r flex flex-col mt-16`}
      >
        {/* Sidebar Header */}
                  ...
                  <CardContent className="p-3">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <div className="flex items-center gap-2">
                          <Badge
                            className={`text-xs ${getStatusBadgeColor(patient.status)}`}
                          >
                            {patient.status}
                          </Badge>
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="border-b bg-card p-6">
              ...
              <div className="p-4 bg-muted/30 rounded-lg">
                ...
                {selectedPatient.diagnosis.secondary &&
                  selectedPatient.diagnosis.secondary.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {selectedPatient.diagnosis.secondary.map(
                        (diagnosis, index) => (
                          <Badge
                            key={index}
                            variant="outline"
