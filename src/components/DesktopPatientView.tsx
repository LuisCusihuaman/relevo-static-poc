...
} from '../data/patients.store';

interface DesktopPatientViewProps {
  patients?: DetailedPatient[]; // Make optional to use store data by default
...
export function DesktopPatientView({ 
  ...
  const enhancedPatients: DetailedPatient[] = patients || getDetailedPatients();
